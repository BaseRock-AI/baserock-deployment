...
#   docker push "$DOCKERHUB_IMAGE:latest"
  ...
  aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin $ECR_REGISTRY
  docker buildx imagetools create  --tag "062853520136.dkr.ecr.us-east-1.amazonaws.com/baserock/onprem/cert-manager-webhook:v1.15.3" "quay.io/jetstack/cert-manager-webhook:v1.15.3"
