...
export GITHUB_APP_ID="baserock-prod-onprem"
export GITHUB_APP_ID_INT="1698340"
export GITHUB_CLIENT_ID="Iv23liZEoEbtKln31I13"
export GITHUB_CLIENT_SECRET="2b3ac55ad7b5360e1f2b8c33f272a9b729e66653"
export GITHUB_PRIVATE_KEY="-----BEGIN RSA PRIVATE KEY-----\\n-----END RSA PRIVATE KEY-----\n"
export GITHUB_REDIRECT_URI="https://${DOMAIN}${DOMAIN_PORT}/it/leService/github/app/callback"
export JWT_PUBLIC_KEY="MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA0rSZXNpxsCo225_PcGq6FYzj87UNbpLiMqHXz2OAYERM0AS4xQcOsSTUqlVdeBeNNtizj58X9omRNX8yq6fmWLEkxCWadaCXaVPeDbIjPqpq1ZcUgEEVOe3rfdssaeZlh9Bl7g5Qx_hrh7pJtBqLPz8vyhwD5ZZJkUmBUEHbB4BIv2ZTYIA_l6K9jH_LHgf9CifgF29MpwC_0FMiFE4EwK8pvxDp_htFQxX-DjggG89z6Lg3KWi-Vr0aGI3-X8zCTS3GenRsr3uP9VllBW_fjX9fV4slTIz_noKLuN5x-NHkg3JA58_SigfXYji5BC7MkKYZdoToCcoYviPDfdJg-wIDAQAB"
...
export BACKEND_CPUS="2"
export BACKEND_CPUS_REQUESTS="2"
...
export BACKEND_MEMORY="4096Mi"
export BACKEND_MEMORY_REQUESTS="4096Mi"
