...
export BITBUCKET_REDIRECT_URI="https://bitbucket.org/site/oauth2/authorize"
...
export BACKEND_CPUS="1"
export BACKEND_CPUS_REQUESTS="1"
...
export BACKEND_MEMORY="4Gi"
export BACKEND_MEMORY_REQUESTS="2Gi"
...
export CELERY_WORKER_MEMORY="2Gi"
export CELERY_WORKER_STORAGE="4Gi"
